...
function cards() {
  ...
  axios.get('http://localhost:3002/menu').then(data => {
    data.data.forEach(({
      img,
      altimg,
      title,
...
function forms(formSelector, modalTimerID) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3002/requests', json).then(data => {
        console.log(data);
...
/* harmony import */ var _modules_customizator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/customizator.js */ "./js/modules/customizator.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const modalTimerID = setTimeout(() => openModal('.modal', modalTimerID), 60000),
    panel = new _modules_customizator_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  panel.render();
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_8__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', modalTimerID);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', "2026-07-01T00:00:00");
